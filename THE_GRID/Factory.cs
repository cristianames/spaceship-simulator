...
namespace AlumnoEjemplos.THE_GRID
{
    public class Factory
    {
        ...
        public Factory()
        {
            ...
            meshes_asteroide_base.Add(cargarMesh("Asteroide\\asteroid1-TgcScene.xml"));
            meshes_asteroide_base.Add(cargarMesh("Asteroide\\asteroid_b-TgcScene.xml"));
            meshes_asteroide_base.Add(cargarMesh("Asteroide\\asteroid_c-TgcScene.xml"));
            TgcTexture normalMapAsteroid = TgcTexture.createTexture(EjemploAlumno.TG_Folder + "Asteroide\\Textures\\3215_Bump.jpg");
