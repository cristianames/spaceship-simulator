...
using AlumnoEjemplos.THE_GRID.Camara;
...
namespace AlumnoEjemplos.THE_GRID
{
    public class EjemploAlumno : TgcExample
    {
        ...
        public override string getName(){ return "Grupo THE_GRID"; }
        ...
        private static string tg_Folder = GuiController.Instance.AlumnoEjemplosMediaDir + "\\THE_GRID\\";
